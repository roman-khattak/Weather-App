...
class WeatherCard extends StatelessWidget { // this is the widget I extracted so that I can use it in multiple places
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: SizedBox(
        width: defaultSize * 33.5,  // making the sizedBox of width 205 (10 * 20.5 = 205) and at the same time we are providing it responsive width
        child: AspectRatio(
          aspectRatio: 1.025,  //aspectRatio: 0.83 means that the width of the widget is 0.83 times the height resulting in a slightly wider and shorter widget compared to a perfect square.
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text('${weatherData.temperature.toStringAsFixed(2)}°C',style: GoogleFonts.rubik(color: Colors.white, fontSize: 40),),

                              const SizedBox(height: 60,),

                              Text(weatherData.description,style: GoogleFonts.poppins(color: Colors.grey[400], fontSize: 19, ),),

                              const SizedBox(height: 20,),

                              Text(
                                DateFormat('yyyy-MM-dd').format(weatherData.date.toLocal()),
                          ...
                          Container(
                            height: 65,
                              width: 90,
                              child: Image.network(weatherData.iconUrl,fit: BoxFit.cover,)),
                        ],
                      ),
                    )
                  )
